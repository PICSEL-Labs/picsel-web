    ...
    <section className="bg-black pt-30 pb-15 lg:pt-42.5 lg:pb-20">
      <Container>
        ...
        <div className="mb-10 text-center lg:mb-15">
          <h2 className="text-[32px] leading-12 font-bold lg:text-[40px] lg:leading-14">
            <span className="text-white">Team </span>
            <span className="text-primary">PICSEL</span>
          </h2>
          <p className="text-text-gray mt-4 text-[14px] leading-6 lg:mt-6 lg:text-[16px] lg:leading-6.5">
            안녕하세요.
            <br />
          ...
          <p className="text-text-gray mt-3 text-[14px] lg:mt-4 lg:text-[16px]">
        ...
        <div className="space-y-10">
          {teamMembers.map((member) => (
            <div key={member.nameEn} className="relative">
              ...
              <div className="bg-bg-card rounded-4 border-border-dark flex flex-col items-center gap-6 border p-6 sm:flex-row sm:p-8 lg:gap-16 lg:p-16">
                <div className="rounded-4 flex h-30 w-30 shrink-0 items-center justify-center bg-[#2C2C2E] sm:h-40 sm:w-40 lg:h-60 lg:w-60">
