        ...
        <div className="space-y-10">
          {teamMembers.map((member) => (
            <div key={member.nameEn} className="relative">
              <div className="absolute -top-[18px] left-6 lg:left-[47px] z-10">
              ...
              <div className="bg-bg-card rounded-4 border border-border-dark flex flex-col sm:flex-row items-center gap-6 lg:gap-16 p-6 sm:p-8 lg:p-16">
                <div className="w-30 h-30 sm:w-40 sm:h-40 lg:w-60 lg:h-60 rounded-4 bg-[#2C2C2E] flex items-center justify-center flex-shrink-0">
