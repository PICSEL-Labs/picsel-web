  ...
  return (
    <section className="bg-gradient-to-b from-[#FFB6D3] to-[#FFC8DC]">
      <Container className="py-20 lg:py-40 text-center">
        <h2 className="text-[24px] sm:text-[32px] lg:text-[40px] font-bold leading-9.5 sm:leading-12 lg:leading-14">
          <span className="text-primary">픽셀</span>에서는 누구나 쉽게 찾고
          <br />
          다시 꺼내볼 수 있어요
        </h2>
        <p className="mt-5 lg:mt-8 text-[14px] sm:text-[16px] lg:text-[18px] text-text-secondary leading-6 lg:leading-7">
