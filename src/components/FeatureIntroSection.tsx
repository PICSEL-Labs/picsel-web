  ...
  return (
    <section className="bg-gradient-to-b from-[#FFB6D3] to-[#FFC8DC]">
      <Container className="py-[80px] lg:py-[160px] text-center">
        <h2 className="text-[24px] sm:text-[32px] lg:text-[40px] font-bold leading-[38px] sm:leading-[48px] lg:leading-[56px]">
          <span className="text-primary">픽셀</span>에서는 누구나 쉽게 찾고
          <br />
          다시 꺼내볼 수 있어요
        </h2>
        <p className="mt-[20px] lg:mt-[32px] text-[14px] sm:text-[16px] lg:text-[18px] text-text-secondary leading-[24px] lg:leading-[28px]">
