...
function PhoneMockup({ label }: { label: string }) {
  return (
    <div className="w-55 lg:w-75 flex-shrink-0">
      <div className="relative w-55 lg:w-75 h-112.5 lg:h-153.5 bg-[#1A1A1A] rounded-8 lg:rounded-11 border-[5px] lg:border-[6px] border-[#333] overflow-hidden shadow-2xl">
        ...
        <div className="w-full h-full bg-gradient-to-b from-[#222] to-[#111] flex items-center justify-center rounded-[27px] lg:rounded-9.5">
    ...
    <section className="bg-white pt-15 lg:pt-22.5">
      ...
      <div className="bg-black">
        <Container className="flex flex-col-reverse lg:flex-row items-center lg:justify-between py-16 lg:py-0 lg:min-h-134.5 gap-8 lg:gap-0">
          <div className="w-30 h-37 lg:w-55 lg:h-[271px]">
            <TwinkleStar />
          </div>
          ...
          <div key={`${activeTab}-${i}`}>
            {section.sectionHeadline && (
              <div className="text-center pt-15 lg:pt-40 pb-10 lg:pb-20">
                <h3 className="text-[24px] sm:text-[32px] lg:text-[48px] font-bold leading-9.5 sm:leading-12 lg:leading-[67px]">
                ...
                <div className="flex justify-center mt-1.5">
                  <div className="w-50 lg:w-75 h-[3px] bg-gradient-to-r from-transparent via-primary/40 to-transparent" />
                </div>
              </div>
            )}
