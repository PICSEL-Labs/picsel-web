    ...
    <section className="bg-linear-to-b from-[#FFD6E8] to-[#FFB6D3]">
      <Container className="py-20 text-center lg:py-30">
        <StaggerContainer staggerDelay={0.2}>
          <motion.h2
            className="text-[28px] leading-10.5 font-bold sm:text-[36px] sm:leading-13 lg:text-[48px] lg:leading-16.75"
          ...
          <motion.p
            className="text-text-secondary mt-8 text-[16px] leading-7 lg:mt-14 lg:text-[20px] lg:leading-7.5"
            variants={staggerChildVariants}
          >
            디지털 최소 단위인 픽셀이 모여 한 장의 사진이 되는 것처럼,
          </motion.p>
          <motion.p
            className="text-text-secondary mt-1 text-[16px] leading-7 lg:text-[20px] lg:leading-9"
            variants={staggerChildVariants}
          >
            수많은 특별한 순간을 모아{" "}
